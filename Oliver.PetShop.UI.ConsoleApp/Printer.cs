...
namespace Oliver.PetShop.UI.ConsoleApp
{
            ...
            while (selection != 8)
            {
                switch (selection)
                {
                    ...
                    case 4:
                        ...
                        var newPrice = price;
                        UpdatePet(idForEdit, newName, newType, newColor, newPreviousOwner, newPrice);
                        break;
                    case 5:
        ...
        private void UpdatePet(int id, string newName, string newType, string newColor, string newPreviousOwner, double newPrice)
        {
